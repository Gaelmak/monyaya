    ...
    return(
        <Container className=" container flex flex-col lg:flex-row lg:justify-between md:items-center gap-8 lg:m-auto py-4 lg:h-screen bg-secondary-50">
            <Container className="lg:w-1/2 flex flex-col justify-between items-center gap-8">
                ...
                Notre mission est de toucher chaque individu de la RDC dans un premier temps, puis 
                d'élargir notre horizon au fil du temps. Parce que nous croyons que tout le monde 
                mérite d'apprendre quelque chose de nouveau, notre mission est de rapprocher les 
                apprenants et les mentors en créant des connexions au niveau local, pour faciliter 
