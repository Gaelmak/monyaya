...
export default function ValueSection(){
    return(
        <Container className='container flex flex-col  justify-center items-center bg-secondary-50 py-8'>
          ...
          <Container className='lg:px-8 md:px-3  py-24 flex flex-col  md:flex-wrap lg:flex-nowrap  md:justify-center md:items-center lg:flex-row gap-20'>
          ...
          <Container className='flex justify-center items-center  lg:w-1/3 md:w-full flex-col md:bg-white md:rounded-2xl  md:shadow-2xl hover:shadow-none  md:p-4' >
              ...
              <Typography component='p' variant='body-base' className='md:px-3 md:py-8 text-justify  py-3 leading-relaxed'>
              <span className="font-semibold hover:text-[#39ae44]">{"L'envie et la capacité d'apprendre"} </span>: Nous croyons que chacun a la capacité d'apprendre et d'enseigner. Nous encourageons 
          ...
          <Container className='flex justify-center items-center  lg:w-1/3 md:w-full flex-col md:bg-white md:rounded-2xl  md:shadow-2xl hover:shadow-none  md:p-4' >
              ...
              <Typography component='p' variant='body-base' className='md:px-3 md:py-8 text-justify  py-3 leading-relaxed'>
              <span className="font-semibold hover:text-[#39ae44]">{"Confiance mutuelle"}</span> : Nous plaçons la confiance au cœur de notre communauté Monyaya. Nous croyons en l'importance 
