...
export const BestProfil = () => {
  ...
  return (
    <Container className="block overflow-hidden py-8 px-4 md:px-8 md:py-8 bg-white">
      ...
      {
        t.map(x => 
          <Container key={x.id} className="basis-1/4 cursor-pointer flex flex-col px-4 py-4 md:px-4 md:py-4 bg-white gap-2 md:gap-4 items-center rounded border-secondary-100 border-[1px]">
