...
import { Company, MainRoutes, SocialNetworks } from "@/lib/page-routes/page-routes";
...
export const Footer = () => {
  ...
  return (
    <footer className="flex gap-16 flex-col md:flex-row justify-center md:justify-between py-16 px-4 md:px-8 md:py-16 bg-black text-white">
