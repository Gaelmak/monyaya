/*
  ...
  - You are about to drop the column `trainerId` on the `Account` table. All the data in the column will be lost.
  ...
  - You are about to drop the `_SubCategoryToTrainer` table. If the table is not empty, all the data it contains will be lost.
...
*/
-- DropForeignKey
ALTER TABLE "Account" DROP CONSTRAINT "Account_trainerId_fkey";
...
-- DropTable
DROP TABLE "_SubCategoryToTrainer";
