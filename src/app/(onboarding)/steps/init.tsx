    ...
    <BackgroundImage>
      <Container className="h-full w-full flex flex-col p-8 lg:justify-center gap-4">
        ...
        <Typography className=" w-full md:w-[50vw] text-white text-center md:text-left">
          ...
          potentiel de nos services. Que vous soyez ici pour explorer de
          nouvelles opportunités, proposer des formations à domicile, ou
          acquerir des nouvelles connaissances, nous sommes là pour vous
