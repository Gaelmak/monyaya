  ...
  return (
    <Container className="px-6 md:px-8 lg:px-[7vw] py-16 flex flex-col gap-20 bg-primary-50">
      <Container className="flex flex-col justify-center m-auto items-center md:w-[60%] gap-4">
        <Typography
          variant="title-base"
          className="md:w-[60%] text-center md:text-left text-xl md:text-3xl font-bold"
        >
      ...
      <Container className="flex flex-col md:flex-row md:justify-between items-center md:pt-6  md:pb-16">
        ...
        <Container className="md:w-1/2 flex flex-col gap-5 py-4">
          <Typography
            variant="title-base"
            className="text-center md:text-left text-xl md:text-3xl font-bold"
          >
          ...
          {OurBenefits.map(({ Icon, title, description }) => (
            <Container key={title} className="flex items-center">
              ...
              <Container className="py-2 flex flex-col gap-0">
                <Typography variant="title-sm" className="font-semibold">
                  {title}
                </Typography>
                <Typography className="leading-1">{description}</Typography>
              </Container>
            </Container>
          ))}
        </Container>
