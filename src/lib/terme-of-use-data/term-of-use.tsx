export const termOfUse = [
  {
    id: "article1",
    title: "1. Objet des Termes et Conditions",
    content:
  ...
  },
  {
    ...
    content: (
      <ol className="list-disc ml-4">
        <li>
          <strong>Utilisateur :</strong> Toute personne visitant ou utilisant la
          plateforme pour bénéficier des services d&apos;apprentissage à
          domicile fournis par les Formateurs.
        </li>
        <li>
          <strong>Formateur ou yaya :</strong> Les prestataires de services
          d&apos;apprentissage inscrits sur la plateforme pour enseigner
  ...
  {
    id: "article4",
    title: "4. Obligations de Monyaya",
    content:
    ...
    content: (
      <div>
        ...
        <ol className="list-disc ml-4">
          ...
          <li>Respecter les conditions établies entre le formateur et lui.</li>
          <li>
            Collaborer de manière active durant le processus
            d&apos;apprentissage.
          </li>
        </ol>
        <p className="mt-2">
          Toute violation de ces conditions peut entraîner la suspension ou la
          résiliation de l&apos;accès à nos services.
        </p>
      </div>
    ),
  },
  {
    id: "article6",
    title: "6. Paiement et Tarification",
    content: (
      <div className="space-y-2">
        <p>
          Les services proposés par les formateurs sont facturés aux
          utilisateurs selon les tarifs indiqués au moment de l&apos;inscription
          à un cours. Le paiement peut s&apos;effectuer via les modes
          disponibles sur la plateforme. Les prix sont fixés par les formateurs
          eux-mêmes, et Monyaya peut prélève une commission pour l’utilisation
          de la plateforme une fois le service réalisée.
        </p>
        <p>
          Pour ce qui est de la sécurité de paiement, Monyaya ne transfère pas
          directement la somme de paiement au prestataire. Les fonds sont
          conservés sur un compte bloqué et seront libérés progressivement en
          fonction de l&apos;avancement de la formation. Si un client prouve que
          le prestataire ne respecte pas les normes de qualité ou les conditions
          d&apos;apprentissage, et que les paiements ont déjà été effectués, le
          client pourra obtenir un remboursement proportionnel à
          l&apos;avancement de la formation, sur présentation des preuves.
        </p>
      </div>
    ),
  },
  ...
  {
    id: "article8",
    title: "8. Garanties et Limitation de Responsabilité",
    content:
  ...
  {
    id: "article10",
    title: "10. Modification des Termes",
    content:
