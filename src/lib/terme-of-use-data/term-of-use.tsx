export const termOfUse = [
    ...
    },
    {
        ...
        content:"Monyaya s'engage à fournir au Client des services d'apprentissage à domicile conformes aux exigences du Client et aux standards de qualité de Monyaya. Monyaya s'engage également à mettre en relation le Client avec des Prestataires qualifiés et expérimentés dans le domaine du service à domicile souhaités"
    },
    {
        id:"article4",
        title:"Obligations du Client",
        content:"Le Client s'engage à fournir à Monyaya toutes les informations nécessaires à la mise en place des services d'apprentissage à domicile. Le Client s'engage également à respecter les consignes des Prestataires et à collaborer avec eux afin de garantir la réussite de l'apprentissage."
    },
    {
        id:"article5",
        title:"Prix et modalités de paiement",
        content:"Les services d'apprentissage à domicile sont facturés au Client au prix de [montant] dollars par [période de facturation / module].Le paiement des services est effectué par [mode de paiement]."
    },
    {
        id:"article6",
    ...
    },
    {
        id:"article10",
        title:"Litiges",
        content:"Tout litige relatif au présent Contrat sera soumis à la compétence exclusive des tribunaux de [ville]."
    },
    {
        id:"article11",
        title:"Dispositions générales",
        content:"Le présent Contrat est soumis à la loi [loi applicable].Toute modification du présent Contrat doit être faite par écrit et signée par les deux parties."
    }
]