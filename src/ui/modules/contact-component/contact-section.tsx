...
export default function ContactSection() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-primary-50 p-4">
            ...
            <ul className="flex flex-col gap-6 mt-4">
              <li className="flex flex-row gap-3 items-center">
                ...
                <div className="flex flex-col">
                  <span className="text-xs md:text-sm">+243 821 611 703</span>
                  <span className="text-xs md:text-sm">+243 997 724 968</span>
                </div>
              </li>
              <li className="flex flex-row gap-3 items-center">
                <Mail size={20} />
                <span className="text-xs md:text-sm">monyaya@gmail.com</span>
              </li>
              <li className="flex flex-row gap-3 items-center">
                <MapPin size={20} />
                <span className="text-xs md:text-sm">Mont Ngafula</span>
              </li>
            </ul>
          </div>
        </div>
