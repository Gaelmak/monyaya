...
export const HowItWorks = () => {
  return (
    <Container className="flex flex-col gap-8 px-4 md:px-8 py-16 bg-primary-400">
      ...
      <Container className="basis-2/3">
        <Tabs
          ...
          className="w-full bg-white rounded p-4 md:p-8 shadow-lg"
        >
          <TabsList className="w-full grid grid-cols-2">
            <TabsTrigger
              value="suscribe-to-training"
              className="basis-1/2 rounded"
            >
              <Typography className="flex-wrap hidden md:block">
                Souscrire à une formation
              </Typography>
              <Typography className="flex-wrap md:hidden">
                Souscrire
                <br />à une formation
              </Typography>
            </TabsTrigger>
