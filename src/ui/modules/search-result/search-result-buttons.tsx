...
export const SearchResultButtons = ({status, trainingId, userId, isMyAccount = false , amLearner = false, id}: Props) => {
    ...
    <Container className="flex flex-row gap-2">
      {
        ...
        <Container className="flex flex-row gap-2">
          ...
          <Buttons Icon={Trash2} disabled={isMyAccount} variant="ghost" className="text-red-500 hover:text-red-600" isLoading={isLoading} buttonType="action" action={() => rejectTraining(id!)}/>
        </Container>
        :
        userId ?
