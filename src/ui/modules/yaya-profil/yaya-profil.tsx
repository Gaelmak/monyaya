...
export const YayaProfil = ({ data, className, children }: Props) => {
  return (
      ...
      <Container className="bg-white rounded shadow-md sticky top-[12vh]">
        {data.map(
          ({
            ...
            <Container
              key={name}
              className={clsx('p-4 flex flex-col gap-4 relative')}
            >
                ...
                <Container className="flex flex-col justify-between gap-4">
                  ...
                  <Container className="basis-3/4 flex flex-col w-full">
                    <Container className="block w-full">
                      <Typography className="text-title-base break-words">
                        {firstName + ' ' + lastName}
                      </Typography>
                    </Container>
                    <Container className="flex flex-col w-full">
                      <Typography variant="body-sm">
                        Résidence : {municipality}
                      </Typography>
                      <Typography variant="body-sm">
                        Yaya depuis le{' '}
